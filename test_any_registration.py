...
def test_reg1():
    try:
        ...
        input1 = browser.find_element(By.XPATH,
                                      "//input[@placeholder='Input your first name']")  # (By.CSS_SELECTOR, "[
        # placeholder='Input your first name']")
        input1.send_keys("Ivan")
        input2 = browser.find_element(By.XPATH,
                                      "//input[@placeholder='Input your last name']")  # "(By.CSS_SELECTOR,
        # [placeholder='Input your last name']")
        input2.send_keys("Petrov")
        input3 = browser.find_element(By.XPATH,
                                      "//input[@placeholder='Input your email']")  # (By.CSS_SELECTOR, "[
        # placeholder='Input your email']")
        input3.send_keys("Smolensk")
        # На всякий случай заполняю необязательные поля при регистрации
        input4 = browser.find_element(By.XPATH,
                                      "//input[@placeholder='Input your phone:']")  # (By.CSS_SELECTOR, "[
        # placeholder='Input your phone:']")
        input4.send_keys("88005553535")
        input4 = browser.find_element(By.XPATH,
                                      "//input[@placeholder='Input your address:']")  # (By.CSS_SELECTOR, "[
